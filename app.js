...
global.blockchain = require(ROOT + '/lib/core/blockchain.js');
global.CJSON = CJSON;
...
global.btcUsdtRobotStartFlag = false;
global.ethUsdtRobotStartFlag = false;
global.uniUsdtRobotStartFlag = false;

const robotRightCurrencyArray = require(ROOT + '/lib/core/robot.js');
global.ROBOT_ARRAY = robotRightCurrencyArray.robotArray;
global.activityFlag = false; // usdt用户活跃度flag
global.activityTimeUtc = new Date().toISOString();
...
let robotOther = require(ROOT + '/lib/core/tradeRobot.js');
robotOther.cancalOrder();
